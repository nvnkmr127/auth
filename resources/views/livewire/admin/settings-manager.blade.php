                ...
                <form wire:submit="save" class="space-y-6">
                    ...
                    <div x-data="{ show: false }" class="relative">
                        ...
                        <input wire:model="apiKey" :type="show ? 'text' : 'password'"
                            class="block w-full px-5 py-4 pr-12 text-sm font-bold bg-slate-50 border-slate-100 rounded-2xl focus:ring-4 focus:ring-primary/10 focus:bg-white focus:border-primary/20 transition-all font-mono"
                            placeholder="••••••••••••••••">
                        <button type="button" @click="show = !show"
                            class="absolute right-4 bottom-4 text-slate-400 hover:text-primary transition-colors">
