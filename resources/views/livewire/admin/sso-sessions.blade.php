<div class="px-4 py-8">
    ...
    <div class="flex items-center justify-between mb-12">
        <div>
            ...
            <p class="text-sm font-medium text-slate-500">Manage active login tokens and prevent reuse of authentication
                requests.</p>
        </div>
    ...
    <div class="premium-card rounded-[2.5rem] overflow-hidden">
        <div class="px-8 py-6 border-b border-slate-50 flex items-center justify-between bg-slate-50/30">
            <h3 class="text-xs font-black text-slate-900 uppercase tracking-[0.2em]">Session Management</h3>
            <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Tracking active login
                tokens</span>
        </div>
            ...
            <table class="w-full text-left">
                <thead>
                    <tr class="bg-gray-50/50">
                        <th class="px-8 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest">Session ID
                        </th>
                        <th class="px-8 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest">Last Used
                        </th>
                        <th class="px-8 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest">Expires In
                        </th>
                        ...
                        <tr class="group hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="px-8 py-4">
                                @if($session->expires_at > now())
                                    <span
                                        class="px-2 py-1 rounded bg-emerald-50 text-emerald-600 font-black text-[8px] uppercase ring-1 ring-emerald-500/20">Active</span>
                                @else
                                    <span
                        ...
                        <tr>
                            <td colspan="4" class="px-8 py-20 text-center">
                                <div class="flex flex-col items-center justify-center text-gray-300">
                                    ...
                                    <span class="text-[10px] font-black uppercase tracking-[0.2em]">No Active Sessions
                                        Found</span>
                                </div>
                            </td>
                        </tr>
