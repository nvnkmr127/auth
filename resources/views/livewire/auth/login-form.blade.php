<div class="flex min-h-screen flex-col justify-center py-12 px-6 lg:px-8 relative overflow-hidden"
    x-data="{ isCovering: false, emailLength: 0 }">
    <!-- Decorative Elements -->
    <div class="absolute inset-0 mesh-gradient pointer-events-none"></div>
    <div
        class="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-amber-200/20 rounded-full filter blur-[120px] animate-pulse">
    </div>
    <div
        class="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-orange-200/20 rounded-full filter blur-[120px] animate-pulse animation-delay-2000">
    </div>
    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-md z-10 text-center relative mb-4">
        ...
        <div class="flex justify-center h-48 relative" :class="{ 'is-covering-eyes': isCovering }">
            <svg width="200" height="200" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg"
                ...
                <!-- Body -->
                <path d="M60 140C60 120 75 110 100 110C125 110 140 120 140 140V180H60V140Z"
                    fill="url(#furGradientBody)" />
                ...
                <g class="mascot-eyes-group"
                    :style="`transform: translate(${Math.min(Math.max(emailLength - 15, -18), 18)}px, 4px)`">
                    ...
                    <!-- Nose -->
                    <path
                        d="M92 102C92 98 96 96 100 96C104 96 108 98 108 102C108 106 103 109 100 109C97 109 92 106 92 102Z"
                        fill="#212121" />
                    <path d="M96 112C96 114 98 116 100 116C102 116 104 114 104 112" stroke="#5D4037" stroke-width="2"
                        stroke-linecap="round" />
                </g>

                <!-- Paws - Redesigned for proper coverage -->
                <g class="bear-arm bear-arm-left">
                    <rect x="40" y="130" width="35" height="50" rx="17.5" fill="#5D4037" stroke="#4E342E"
                        stroke-width="1" />
                ...
                <g class="bear-arm bear-arm-right">
                    <rect x="125" y="130" width="35" height="50" rx="17.5" fill="#5D4037" stroke="#4E342E"
                        stroke-width="1" />
                ...
                <defs>
                    <linearGradient id="furGradientHead" x1="100" y1="35" x2="100" y2="145"
                        gradientUnits="userSpaceOnUse">
                        <stop stop-color="#795548" />
                        <stop offset="1" stop-color="#5D4037" />
                    </linearGradient>
                    <linearGradient id="furGradientBody" x1="100" y1="110" x2="100" y2="180"
                        gradientUnits="userSpaceOnUse">
    ...
    <div class="mt-6 sm:mx-auto sm:w-full sm:max-w-[420px] z-10">
        <div class="dark-glass p-8 sm:p-10 rounded-[2.5rem] border-0 shadow-2xl ring-1 ring-black/5">
            <form wire:submit="login" class="space-y-6">
                ...
                @else
                    <div class="anime-in-slide-down">
                        <div class="mb-6 p-4 bg-amber-50 rounded-2xl border border-amber-100/50 flex items-start gap-4">
                            <div
                            ...
                            <div>
                                <h4 class="text-xs font-black text-amber-900 uppercase tracking-tight">Security Check</h4>
                                <p class="text-[10px] font-bold text-amber-700/70 mt-1 leading-relaxed">
                                    We've sent a 6-digit code to <span class="text-amber-900">{{ $email }}</span> and your
                        ...
                        <button type="button" wire:click="$set('requiresOtp', false)"
                            class="mt-4 text-[10px] font-black text-slate-400 uppercase tracking-widest hover:text-primary transition-colors ml-1">
                ...
                <div>
                    <button type="submit"
                        ...
                        <span wire:loading.remove>{{ $requiresOtp ? 'Verify & Continue' : 'Sign in to account' }}</span>
                        <span wire:loading class="flex items-center gap-2">
                            ...
                            {{ $requiresOtp ? 'Verifying Code...' : 'Securing Session...' }}
                        </span>
                    </button>
                </div>
            </form>
